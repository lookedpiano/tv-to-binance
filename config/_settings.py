...
ALLOWED_SYMBOLS = [
    ...
    "BANANAUSDT", "BCHUSDT", "TNSRUSDT", "BEAMXUSDT", "BICOUSDT",
    "BONKUSDT", "CAKEUSDT", "CFXUSDT", "CGPTUSDT", "CHZUSDT",
    "COOKIEUSDT", "COTIUSDT", "CRVUSDT",
    
    # no USDC pairs
    "XNOUSDT", "BATUSDT", "DUSKUSDT", "GLMUSDT", "AUDIOUSDT",
    "AXLUSDT", "BNSOLUSDT", "BTTCUSDT", "C98USDT", "CTKUSDT",
    ...
    "BANANAUSDC", "BCHUSDC", "TNSRUSDC", "BEAMXUSDC", "BICOUSDC",
    "BONKUSDC", "CAKEUSDC", "CFXUSDC", "CGPTUSDC", "CHZUSDC",
    "COOKIEUSDC", "COTIUSDC", "CRVUSDC",
